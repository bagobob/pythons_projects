...
if cross_road == "left":
    mission_lake = input("You come to a lake. There is an island in the middle of the lake. Type 'wait' to wait a boat. Type 'swim' to swim across.\n")
    if mission_lake == "wait":
